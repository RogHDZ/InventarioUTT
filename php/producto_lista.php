<?php
			        ...
			        <div class="media-content">
			            <div class="content">
			              <p>
			                ...
			                <strong>CODIGO:</strong> '.$rows['producto_codigo'].', <strong>PRECIO:</strong> $'.$rows['producto_precio'].', <strong>Comentarios:</strong> '.$rows['producto_stock'].', <strong>Edificio:</strong> '.$rows['categoria_nombre'].', <strong>REGISTRADO POR:</strong> '.$rows['usuario_nombre'].' '.$rows['usuario_apellido'].'
			              </p>
			            </div>
	...
	if($total>0 && $pagina<=$Npaginas){
		$tabla.='<p class="has-text-right">Mostrando mobiliario <strong>'.$pag_inicio.'</strong> al <strong>'.$pag_final.'</strong> de un <strong>total de '.$total.'</strong></p>';
	}
