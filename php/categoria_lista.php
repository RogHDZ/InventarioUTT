<?php
		...
		foreach($datos as $rows){
			$tabla.='
				<tr class="has-text-centered" >
                    ...
                    <td>
                        <a href="index.php?vista=product_category&category_id='.$rows['categoria_id'].'" class="button is-link is-rounded is-small">Ver mobiliario</a>
                    </td>
                    <td>
	...
	if($total>0 && $pagina<=$Npaginas){
		$tabla.='<p class="has-text-right">Mostrando edificios <strong>'.$pag_inicio.'</strong> al <strong>'.$pag_final.'</strong> de un <strong>total de '.$total.'</strong></p>';
	}
