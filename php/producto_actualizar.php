<?php
    ...
    if($codigo=="" || $nombre=="" || $marca=="" || $modelo=="" || $modelo=="" || $marerial==""
    || $serie=="" || $estado=="" || $factura=="" || $fecha=="" || $precio=="" || $arubic==""
    ...
    producto_marca=:marca,producto_modelo=:modelo,producto_material=:material,producto_serie=:serie,producto_estado=:estado,
    producto_factura=:factura,producto_fecha=:fecha,producto_precio=:precio,producto_arubic=:arubic,producto_ubicacion=:ubicacion,
