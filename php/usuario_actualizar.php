<?php
    ...
    $actualizar_usuario=$actualizar_usuario->prepare("UPDATE usuario SET usuario_codigo=:codigo, usuario_nombre=:nombre,usuario_apellido=:apellido,usuario_usuario=:usuario,usuario_clave=:clave,usuario_email=:email WHERE usuario_id=:id");
