...
<div class="container is-fluid mb-6">
	<?php if($id==$_SESSION['id']){ ?>
		...
		<h2 class="subtitle"style="text-align: center;">Actualizar datos de cuenta</h2>
	<?php }else{ ?>
...
<div class="container pb-6 pt-6">
	...
	<form action="./php/usuario_actualizar.php" method="POST" class="FormularioAjax" autocomplete="off" >
		...
		<div class="column">
		    	<div class="control">
					<label>Código</label>
				  	<input class="input" type="text" name="usuario_codigo" pattern="[a-zA-Z0-9]{4,20}" maxlength="70" required value="<?php echo $datos['usuario_codigo']; ?>" >
				</div>
		  	</div>
		  	<div class="column"> 
		    	<div class="control">
