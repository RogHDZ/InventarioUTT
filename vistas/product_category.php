<div class="container is-fluid mb-6">
    ...
    <h2 class="subtitle"style="text-align: center;">Lista de mobiliario por edificio</h2>
</div>
...
<div class="container pb-6 pt-6">
    ...
    <div class="columns">
        <div class="column is-one-third">
            <h2 class="title has-text-centered">Edificio</h2>
            <?php
                $categorias=conexion();
                ...
                if($categorias->rowCount()>0){
                    ...
                    echo '<p class="has-text-centered" >No hay edificios registrados</p>';
                }
                $categorias=null;
            ?>
        </div>
        <div class="column">
            <?php
                ...
                if($check_categoria->rowCount()>0){
                    ...
                    echo '<h2 class="has-text-centered title" >Seleccione un edificio para empezar</h2>';
                }
