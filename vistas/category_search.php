<div class="container is-fluid mb-6">
    <h1 class="title"style="text-align: center;">Edificios</h1>
    <h2 class="subtitle"style="text-align: center;">Buscar por Edificios</h2>
</div>
            ...
            <form action="" method="POST" autocomplete="off" >
                ...
                <div class="field is-grouped">
                    <p class="control is-expanded">
                        <input class="input is-rounded" type="text" name="txt_buscador" placeholder="¿Qué edificio estas buscando?" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ ]{1,30}" maxlength="30" >
                    </p>
                    <p class="control">
