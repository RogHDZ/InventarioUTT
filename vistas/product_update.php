<div class="container is-fluid mb-6">
	...
	<h2 class="subtitle"style="text-align: center;">Actualizar mobiliario</h2>
</div>
		  	...
		  	<div class="column">
		    	<div class="control">
					<label>Comentarios</label>
				  	<input class="input" type="text" name="producto_stock" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ().,$#\-\/ ]{1,70}" maxlength="90" required value="<?php echo $datos['producto_stock']; ?>" >
				</div>
		  	</div>
		  	<div class="column">
